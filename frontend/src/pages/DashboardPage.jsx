    ...
    <>
      <div className="min-h-screen bg-base-300">
        ...
        <div className="container mx-auto px-6 pb-16">
          ...
          {/* ✅ Quiz Card */}
          {quizScore && (
            <div className="mt-6 bg-zinc-900/60 backdrop-blur rounded-2xl p-5 w-[280px] shadow-md border border-zinc-800">
              <div className="flex items-center gap-2 mb-3">
                <Trophy className="text-yellow-400 w-5 h-5" />
                <h2 className="font-semibold text-lg">Latest Quiz</h2>
              </div>
